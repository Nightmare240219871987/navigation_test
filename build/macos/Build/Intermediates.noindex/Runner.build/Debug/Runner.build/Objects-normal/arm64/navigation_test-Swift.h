...
#ifndef NAVIGATION_TEST_SWIFT_H
#define NAVIGATION_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="navigation_test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15navigation_test11AppDelegate")
...
SWIFT_CLASS("_TtC15navigation_test17MainFlutterWindow")
